...
<li class="breadcrumb-item active" aria-current="page"> <a href="{{ route('budget.index') }}">
        {{ __('Budget Plannner') }}</a></li>
<li class="breadcrumb-item active" aria-current="page"> <a href="#"> {{ __('Budget Plannner Create') }}</a></li>
@endsection
        ...
        <div class="card-body">
            ...
            <div class="row ">
                ...
                <div class="form-group col-md-4">
                    ...
                    {{ Form::select('period', $periods,null, array('class' => 'form-control multi-select period','required'=>'required')) }}
                ...
                <div class="form-group  col-md-4">
                    <div class="btn-box">
                        ...
                        {{ Form::select('year',$yearList,isset($_GET['year'])?$_GET['year']:'', array('class' => 'form-control multi-select')) }}
                    </div>
                </div>
                    ...
                    <table class="table table-striped mb-0" id="dataTable-manual">
                        ...
                        <tbody>
                            ...
                            <tr>
                                @foreach($monthList as $month)
                                <td>
                                    <input type="number" class="form-control pl-1 pr-1 income_data {{$month}}_income"
                                        data-month="{{$month}}" name="income[{{$productService->id}}][{{$month}}]"
                            ...
                            <tr>
                                @foreach($monthList as $month)
                                <td>
                                    <input type="number" class="form-control pl-1 pr-1 expense_data {{$month}}_expense"
                                        data-month="{{$month}}" name="expense[{{$productService->id}}][{{$month}}]"
                    ...
                    <table class="table table-striped mb-0" id="dataTable-manual">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control income_data {{$month}}_income"
                                        data-month="{{$month}}" name="income[{{$productService->id}}][{{$month}}]"
                                        value="0" id="income_data_{{$month}}">
                                </td>
                                @endforeach
