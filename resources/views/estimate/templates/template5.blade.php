            ...
            <div class="estimate-header">
                <table class="vertical-align-top">
                    <tbody>
                        <tr>
                            <td>
                                <h3 style="display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: {{$color}}; color: {{$font_color}};">{{__('estimate') }}</h3>
                                <div class="view-qrcode" style="margin-left: 0; margin-bottom: 15px; {{ $code == 'on' ?  'display:block' : 'display:none' }}">
