        ...
        <div class="estimate-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid {{ $color }}; padding-top: 5px;">{{ ('estimate') }}</h3>
                            <div class="view-qrcode" style="margin-top: 5px; margin-left: 0; margin-right: 0; {{ $code == 'on' ?  'display:block' : 'display:none' }}">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <p><b style="color: {{ $color }}"> FROM:</b><br>
