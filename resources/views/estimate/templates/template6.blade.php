...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{   \App\Models\Utility::getValByName('SITE_RTL') == 'on'?'rtl':''}}">
    ...
    <body>
        <div class="estimate-preview-main">
            <div class="estimate-header" style="border-top: 15px solid {{$color}}; background: #f8f8f8;">
                <table>
                    <tbody>
                        <tr>
                            <td >
                                <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold;">{{ ('estimate') }}</h3>
                            </td>
                            <td class="text-right">
            ...
            <div class="estimate-body" style="border-bottom: 15px solid {{ $color }}">
                <table class="vertical-align-top">
                    <tbody>
                        <tr>
                            <td style="font-size: 13px;">
                                <strong style="margin-bottom: 10px; display:block;">From: Crmgo</strong>
                                <p>
