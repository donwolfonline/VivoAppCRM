...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{   \App\Models\Utility::getValByName('SITE_RTL') == 'on'?'rtl':''}}">
    ...
    <body>
        <div class="estimate-preview-main" style="border-right:40px solid {{ $color }}">
            <div class="estimate-header">
                <table>
                    <tbody>
                        <tr>
                            <td >
                                <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; margin-bottom: 10px; color: {{ $color }};">{{ ('estimate') }}</h3>
                                {{-- <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold;  ">{{__('estimate') }}</h3> --}}
                            ...
                            <td>
                                <table class="no-space">
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <div class="view-qrcode" style="margin-top: 0; {{ $code == 'on' ?  'display:block' : 'display:none' }}">
            ...
            <div class="estimate-body" style="padding-right: 0;">
