...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{   \App\Models\Utility::getValByName('SITE_RTL') == 'on'?'rtl':''}}">
    <head>
        ...
        <title>Hong Kong - estimate</title>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">
                                <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: {{$color}};">{{__('estimate') }}</h3>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <td>
                                <table class="no-space">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="view-qrcode" style=" {{ $code == 'on' ?  'display:block' : 'display:none' }}">
