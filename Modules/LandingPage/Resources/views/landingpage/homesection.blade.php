                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('home_buy_now_link', $settings['home_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Buy Link')]) }}
                                        @error('mail_port')
                                            <span class="invalid-mail_port" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="choose-files mt-5">
                                            <label for="home_logo">
                                                ...
                                                <input type="file" name="home_logo" id="home_logo"
                                                    class="form-control file" data-filename="home_logo">
                                            </label>
                                        </div>
                                        @error('home_logo')
                                            <div class="row">
                                                    ...
                                                    <div class="row align-items-center ">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="{{ $logo.'/home_logo.png' }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">
